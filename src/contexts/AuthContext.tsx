...
export function hasPermission(role: UserRole | undefined, permission: string): boolean {
  ...
  const permissions: Record<UserRole, string[]> = {
    warehouse: ['view_stock', 'scan_barcode', 'create_request', 'stock_in', 'ship_stock'], // Added ship_stock
    cashier: ['view_stock', 'view_requests', 'create_surat_jalan', 'receive_goods'], // Added receive_goods
    auditor: ['view_surat_jalan', 'approve_reject', 'view_reports', 'verify_shipments'], // Changed scope
    main_office: ['approve_requests', 'manage_cash', 'view_reports'], // New role
    admin: ['*'],
  };
