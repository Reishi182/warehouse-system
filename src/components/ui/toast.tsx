...
const toastVariants = cva(
  cn(
    ...
    "rounded-2xl border-2 p-4 pr-10 shadow-2xl backdrop-blur-sm",
  ...
  ),
  {
    variants: {
      variant: {
        default: "border-border/50 bg-background/95 text-foreground shadow-primary/10",
        success: "border-green-500/30 bg-green-50/95 dark:bg-green-950/95 text-green-900 dark:text-green-100",
        destructive: "border-red-500/30 bg-red-50/95 dark:bg-red-950/95 text-red-900 dark:text-red-100",
        warning: "border-yellow-500/30 bg-yellow-50/95 dark:bg-yellow-950/95 text-yellow-900 dark:text-yellow-100",
        info: "border-blue-500/30 bg-blue-50/95 dark:bg-blue-950/95 text-blue-900 dark:text-blue-100",
      },
    },
    defaultVariants: {
      variant: "default",
