...
const navGroups: NavItem[] = [
  ...
  // Keuangan submenu
  {
    ...
    children: [
      { label: 'Cash', icon: Wallet, href: '/cash-transfer', roles: ['cashier', 'main_office', 'admin'] },
      ...
      { label: 'Riwayat Penjualan', icon: Receipt, href: '/sales', roles: ['admin'] },
    ],
  },

  { label: 'Persetujuan', icon: ClipboardCheck, href: '/approval', roles: ['auditor', 'admin'] },
  { label: 'Laporan', icon: BarChart3, href: '/reports', roles: ['main_office', 'auditor', 'admin'] },
