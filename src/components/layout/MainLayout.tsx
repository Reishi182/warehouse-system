    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="md:pl-20 flex flex-col h-screen overflow-hidden relative">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0 overflow-hidden">
          <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-primary/5 dark:bg-primary/10 rounded-full blur-[100px]"></div>
          <div className="absolute bottom-[-10%] left-[10%] w-[400px] h-[400px] bg-blue-100/50 dark:bg-blue-900/20 rounded-full blur-[120px]"></div>
          <div className="absolute top-[40%] left-[40%] w-[500px] h-[500px] bg-amber-50/60 dark:bg-amber-900/10 rounded-full blur-[120px]"></div>
        </div>
